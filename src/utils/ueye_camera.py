...
class IDSCam():
    ...
    def __init__(self):
        ...
        self.sensorHeight_ctype = ueye.c_int(2560)
        self.sensorWidth_ctype = ueye.c_int(1920)
        self.currentWidth = 2560
        self.currentHeight = 1920  
    ...
    def connect(self):
        ...
        if connectRet == 0: # on succesful connection
            ...
            ueye.is_SetColorMode(self.CamID,ueye.IS_CM_MONO8)  
    ...
    def capture_image(self):
        ...
        imageArray = np.zeros((self.sensorHeight_ctype.value,self.sensorWidth_ctype.value), dtype=np.uint8)
        
        ueye.is_FreezeVideo(self.CamID, ueye.IS_GET_LIVE)
